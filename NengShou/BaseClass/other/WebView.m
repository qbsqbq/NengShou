...
@interface WebView () <UIAlertViewDelegate>
...
@property (nonatomic, copy) void (^shouldStartBlock)(WebView *webView, NSString *title, NSURL *url);
@property (nonatomic, copy) void (^didStartBlock)(WebView *webView);
@property (nonatomic, copy) void (^didFinishBlock)(WebView *webView, NSString *title, NSURL *url);
@property (nonatomic, copy) void (^didFailBlock)(WebView *webView, NSString *title, NSURL *url, NSError *error);
...
//    [buttonBack setTitle:@"<" forState:UIControlStateNormal];
    [buttonBack setImage:[UIImage imageNamed:@"houtui-4"] forState:UIControlStateNormal];
...
//    [buttonForward setTitle:@">" forState:UIControlStateNormal];
    [buttonForward setImage:[UIImage imageNamed:@"houtui-3"] forState:UIControlStateNormal];
...
//    [buttonReload setTitle:@"刷新" forState:UIControlStateNormal];
    [buttonReload setImage:[UIImage imageNamed:@"shuaxin"] forState:UIControlStateNormal];
...
//    [buttonReload setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
    ...
    //    buttonReload.backgroundColor = [UIColor clearColor];
//    [buttonHome setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//    [buttonHome setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
    buttonHome.tag = 1004;
    [buttonHome addTarget:self action:@selector(buttonAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    CGFloat widthButton = (self.frame.size.width / 4);
    CGFloat heightButton = 40.0;
    
    self.view1 = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, widthButton, heightButton)];
    [self.buttonView addSubview:self.view1];
    [self.view1 addSubview:buttonBack];
    
    self.view2 = [[UIView alloc] initWithFrame:CGRectMake(widthButton, 0.0, widthButton, heightButton)];
    [self.buttonView addSubview:self.view2];
    [self.view2 addSubview:buttonForward];
    
    self.view3 = [[UIView alloc] initWithFrame:CGRectMake(widthButton*2, 0.0, widthButton, heightButton)];
    [self.buttonView addSubview:self.view3];
    [self.view3 addSubview:buttonReload];
    
    self.view4 = [[UIView alloc] initWithFrame:CGRectMake(widthButton*3, 0.0, widthButton, heightButton)];
    [self.buttonView addSubview:self.view4];
    [self.view4 addSubview:buttonHome];
...
- (void)resetButtonViewUI
{
    if (self.showActionButton)
    {
        ...
        self.lineView.frame = CGRectMake(0.0, 0.0, self.frame.size.width, 0.5);
        
        self.view1.frame = CGRectMake(0.0, 0.0, widthButton, heightButton);
        UIButton *buttonBack = (UIButton *)[self.buttonView viewWithTag:1001];
        buttonBack.frame = CGRectMake(self.view1.frame.size.width/2-widthBut/2, self.view1.frame.size.height/2-heightBut/2, widthBut, heightBut);
        
        self.view2.frame = CGRectMake(widthButton, 0.0, widthButton, heightButton);
        UIButton *buttonForward = (UIButton *)[self.buttonView viewWithTag:1002];
        buttonForward.frame = CGRectMake(self.view2.frame.size.width/2-widthBut/2, self.view2.frame.size.height/2-heightBut/2, widthBut, heightBut);
        
        self.view3.frame = CGRectMake(widthButton*2, 0.0, widthButton, heightButton);
        UIButton *buttonReload = (UIButton *)[self.buttonView viewWithTag:1003];
        buttonReload.frame = CGRectMake(self.view3.frame.size.width/2-widthBut/2, self.view3.frame.size.height/2-heightBut/2, widthBut, heightBut);
        
        self.view4.frame = CGRectMake(widthButton*3, 0.0, widthButton, heightButton);
        UIButton *buttonHome = (UIButton *)[self.buttonView viewWithTag:1004];
        buttonHome.frame = CGRectMake(self.view4.frame.size.width/2-widthBut/2, self.view4.frame.size.height/2-heightBut/2, widthBut, heightBut);
    }
}
 ...
 *  @param didFail     失败
 */
- (void)loadRequest:(void (^)(WebView *webView, NSString *title, NSURL *url))shouldStart didStart:(void (^)(WebView *webView))didStart didFinish:(void (^)(WebView *webView, NSString *title, NSURL *url))didFinish didFail:(void (^)(WebView *webView, NSString *title, NSURL *url, NSError *error))didFail
{
